...
function displayProducts (products)
{
    ...
    products.forEach((ele,ind) =>
    {
        ...
        pimage.src = ele.thumbnail;
        pimage.alt = ele.title;
        const ptitle = document.createElement('h2');
        ptitle.textContent = ele.title;
        const pprice = document.createElement('p');
        pprice.textContent ="Price : $"+ ele.price
        pdiv.append(pimage, ptitle, pprice);
...
{
    console.log(e);
    let newArr = products.filter((ele, i) => ele.category == e)
    displayProducts(newArr)
}
function filterPrice (a, b)
{
    let newArr = products.filter((e, i) => e.price >= a && e.price <= b);

    displayProducts(newArr.sort((a,b)=>a.price-b.price))
}